...
/* eslint-disable */
/**
 * 原生orientationchange兼容性修复
 *
 * window.addEventListener('myorientationchange', function (e) {
 *   if (window.myorientation.current === 'portrait') {
 *     // 处理竖屏代码逻辑
 *   } else { // landscape
 *     // 处理横屏代码逻辑
 *   }
...
;(function (win) {
  ...
  var eventType = 'myorientationchange';
